...
const LandingPage = () => {
  return (
    <div class="pagInicio">
      ...
      <h3> Postulante: Reina Sarina Bustamante Paco</h3>
      <h3> Bienvenido</h3>
      <hr />
      ...
      <hr />
      <table>
        <tr><td>Componentes funcionales y de clase</td>
